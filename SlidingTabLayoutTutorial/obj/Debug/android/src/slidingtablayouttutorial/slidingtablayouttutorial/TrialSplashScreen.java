package slidingtablayouttutorial.slidingtablayouttutorial;
...
public class TrialSplashScreen extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen.this, md542fe3a4400997dc34bfe26039bfe99df.MainActivity.class);
